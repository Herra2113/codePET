...
const Login = ({ setUsuarioLogueado }) => {
  ...
  return (
    <Container className="my-3" id="login">
      <Form
        className="contenedor-formulario mx-auto p-5"
      ...
      >
          ...
          <Form.Control
            ...
            {...register("email", {
              ...
              pattern: {
                ...
                message:
                  "El correo debe tener el siguiente patron: email@dominio.com",
              },
            })}
          />
            ...
            {...register("password", {
              ...
              pattern: {
                value:
                  /^(?=.*\d)(?=.*[\u0021-\u002b\u003c-\u0040])(?=.*[A-Z])(?=.*[a-z])\S{8,16}$/,
                message:
                  "La contraseña debe tener entre 8 y 16 caracteres, al menos una mayuscula, al menos un numero y al menos un caracter especial",
              },
            })}
          />
        ...
        <div className="d-flex">
          <button
            type="submit"
            disabled={loading}
            className="mx-auto boton fw-bold"
          >
            {loading ? (
              <SpinnerLoader color="#ffeee3" height="2" width="2" />
            ) : (
              "Ingresar"
            )}
          </button>
      ...
      <div className="my-4 mx-auto d-flex flex-column">
        ...
        <Link className="mx-auto boton fw-bold" to="/*">
          Registrarse
        </Link>
      </div>
    </Container>
