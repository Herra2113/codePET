        ...
        <Card>
          <Row className="flex-row justify-content-center my-3">
            <Col xs={12} sm={12} md={12} lg={4}>
              <h1 className="text-start ms-3 fw-bold fs-2">
                Planes de cuidado
              </h1>
              <p className="text-start ms-3">
                Nuestra veterinaria ofrece un servicio exclusivo de planes de
                cuidado mensuales diseñados para garantizar la salud y el
                bienestar óptimo de las mascotas a lo largo de diferentes etapas
                de su vida. Estos planes están diseñados pensando en las
                necesidades específicas de cada etapa, brindando un enfoque
                proactivo y completo para el cuidado de las mascotas.
              </p>
            </Col>
            <Col
              xs={12}
            ...
            >
              <Row xs={1} md={2} lg={3} className="g-4">
                ...
                <Col>
                  <Card className="mx-1 border-0">
                    <Card.Body>
                      <Card.Title className="text-center">Madurando</Card.Title>
                ...
                <Col>
                  <Card className="mx-1 border-0">
                    <Card.Body>
                      <Card.Title className="text-center ">Adultos</Card.Title>
