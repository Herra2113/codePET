...
export function Publicacion() {
  ...
  const { error, data, loading, setError, setData, setLoading } =
    useFetchGetJson(URL_PUBLICACIONES + "/" + params.id);
  if (data?.active) {
    return (
      <Container fluid className="my-5">
        <Row className="mt-5">
          <Col
            xs={{ span: 8, offset: 2 }}
            className="p-3 bg-body-tertiary mt-5"
          >
              ...
              {data == null ? (
                ...
                <Container>
                  <Row className="justify-content-center align-self-center">
                    ...
                    <Col xs={12}>
                      <p className="text-secondary text-end p-1">
                        <i>{data.updatedAt.slice(0, 10)}</i>
                      </p>
                    </Col>
                    <Col xs={12}>
                      ...
                      <div className="m-3 text-center">
                        {loading ? (
                          ...
                          <img
                            ...
                            onError={(e) => {
                              e.target.src =
                                "https://cristian021195.github.io/portfolio/img/others/404-image.svg";
                            }}
                            onLoad={(e) => {
                              e.target.className =
                                "my-3 bg-secondary rounded p-2";
                            }}
                            style={{ width: "100%" }}
                            src={data?.imagen + ""}
