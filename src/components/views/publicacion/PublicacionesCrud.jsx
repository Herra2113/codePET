...
export const PublicacionesCrud = () => {
  const {
    ...
    setLoading,
    setRenew,
  } = useFetchGetJson(URL_PUBLICACIONES);
    ...
    fetch(URL_PUBLICACIONES + "/activar/" + id, {
      ...
      .then((res) => {
        res.activa
          ...
          : toast(res.mensaje, 3000, "bg-warning text-dark", false);
      })
      .catch((err) => {
        setData(
          data?.map((d) => {
          ...
          <div>
            ...
            >
              ...
              <input
                type="text"
                name="titulo"
                placeholder="Ej: #00X o Vacío para buscar todos"
                    ...
                    <tr key={pi}>
                      ...
                      <td>
                        ...
                        >
                          ...
                          <button className="btn btn-sm" title="activar">
                            <input
                              type="checkbox"
                              onClick={() => togglePublicacion(p._id, p.active)}
          ...
          >
            <Modal.Body>
              ...
              <textarea
                ...
                id="contenido"
                name="contenido"
                defaultValue={selected.contenido || ""}
                cols="30"
                rows="10"
                minLength={15}
                maxLength={550}
              ...
              <div className="border rounded p-2">
                <label>
                  ...
                  <input
                    type="checkbox"
                    onChange={(e) => {
                      addTags(e.target.value, e.target.checked);
                    }}
            ...
            <Modal.Footer>
              ...
              >
                Guardar &nbsp;
                {loading && (
                  <SpinnerLoader color="white" height="1" width="1" />
                )}{" "}
              </button>
            </Modal.Footer>
          </form>
