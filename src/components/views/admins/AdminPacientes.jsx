  ...
  return (
    <section className="container mt-5">
      <div className="d-flex justify-content-center mt-5">
        <h1 className="mt-5 fw-bold  p-2 titular fs-1">Listado de pacientes</h1>
      </div>
      <div className="align-self-center mt-5 row justify-content-around">
        <Link
          to={"/administrador/turno"}
          className="btn btn-secondary col-8 col-md-5 mt-3"
        >
          Administrador de turnos
        </Link>
        <Button onClick={handleShow} className=" btn-dark col-8 col-md-5 mt-3">
          Agregar Paciente
        </Button>
      </div>
          ...
          {pacientes.map((paciente) => {
            return (
              <Fragment key={paciente._id}>
                <Col xs={12}>
                  <Card className="border border-5 border-black m-2">
                    <Card.Body className="container-fluid bg-secondary-subtle">
                      <Row className="d-flex justify-content-around p-0">
                        <Col
                          ...
                          md={1}
                          lg={1}
                          className="d-flex justify-content-start align-self-start p-0"
                        >
                          <Card.Img
                            className="w-75"
                            variant="top"
                        ...
                        <Col xs={8} md={9} lg={10} className="p-0">
                          <ListGroup className="list-group-flush border">
                            ...
                            <ListGroup.Item>
                              ...
                              {fechaParseada(paciente.fechaNacimiento).replace(
                                /^(\d{4})-(\d{2})-(\d{2})$/g,
                                "$3/$2/$1"
                              )}
                            </ListGroup.Item>
                      ...
                      <ListGroup className="list-group-flush">
                        ...
                        <ListGroup.Item>
                          <strong>Apellido Dueño: </strong>
                          {paciente.apellidoDuenio}
                        </ListGroup.Item>
                        <ListGroup.Item>
                          <strong>Email: </strong>
                          {paciente.email}
