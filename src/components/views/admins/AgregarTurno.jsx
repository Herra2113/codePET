    ...
    crearTurno(turnoNuevo)
      .then((respuesta) => {
        if (respuesta.status === 201) {
          ...
          Swal.fire(
            "error",
            "No se pudo crear el turno correctamente, Excepcion no controlada o Error de Servidor, vuelva a intentarlo más tarde",
            "error"
          );
        }
      })
        ...
        <Form onSubmit={handleSubmit(onSubmit)}>
          ...
          <Form.Group className="mb-3" controlId="hora">
            ...
            <Form.Select
              ...
              {...register("hora", {
                required: "El horario es un dato obligatorio",
              })}
            >
          ...
          <Form.Group className="mb-3" controlId="formaPago">
            ...
            <Form.Select
              ...
              {...register("formaPago", {
                required: "La forma de pago es un dato obligatorio",
              })}
            >
